...
if (!connectionString) {
    console.error('❌ Error: DATABASE_URL or DATABASE_URL_SUPABASE environment variable is not defined.');
    process.exit(1);
}
const adapter = new _adapterpg.PrismaPg({
    connectionString
});
const prisma = new _clientts.PrismaClient({
    adapter
});
async function main() {
    ...
    const defaultPassword = await _bcrypt.hash('Password123!', 10);
    ...
    const unitData = [
        ...
        },
        {
            ...
            status: _clientts.UnitStatus.MAINTENANCE
        },
        {
            unitNumber: 'B-201',
        ...
        },
        {
            ...
            status: _clientts.UnitStatus.VACANT
        },
        {
            unitNumber: 'B-204',
            buildingName: 'Griya Asri Block B',
    ...
    const units = await Promise.all(unitData.map((u)=>prisma.units.create({
            data: u
        })));
    ...
    const adminUser = await prisma.users.create({
        data: {
            ...
            role: _clientts.UserRole.EMPLOYEE,
            gender: _clientts.Gender.MALE
        }
    });
    const adminEmployee = await prisma.employees.create({
        data: {
            ...
            employeePosition: _clientts.EmployeeRole.ADMIN,
            workingHours: 40,
            salary: 8500000,
            bonus: 1000000
        }
    ...
    const managerUser = await prisma.users.create({
        data: {
            ...
            password: defaultPassword,
            role: _clientts.UserRole.EMPLOYEE,
            gender: _clientts.Gender.FEMALE
        }
    });
    const managerEmployee = await prisma.employees.create({
        data: {
            ...
            employeePosition: _clientts.EmployeeRole.PROPERTY_MANAGER,
            workingHours: 40,
            salary: 10000000,
            bonus: 1500000
        }
    ...
    const techEmployee = await prisma.employees.create({
        data: {
            ...
            employeePosition: _clientts.EmployeeRole.TECHNICIAN,
            workingHours: 40,
            salary: 6000000,
            bonus: 500000
        }
    ...
    const secEmployee = await prisma.employees.create({
        data: {
            ...
            employeePosition: _clientts.EmployeeRole.SECURITY,
            workingHours: 48,
            salary: 5500000,
            bonus: 400000
        }
    ...
    const headResident1 = await prisma.residents.create({
        data: {
            ...
            registrationMethod: _clientts.RegistrationMethod.USER_DRIVEN,
    ...
    const headResident2 = await prisma.residents.create({
        data: {
            ...
            residentStatus: _clientts.ResidentStatus.HEAD_HOUSE_HOLD,
            registrationStatus: _clientts.RegistrationStatus.APPROVED,
            registrationMethod: _clientts.RegistrationMethod.ADMIN_DRIVEN,
    ...
    const pendingResident = await prisma.residents.create({
        data: {
            ...
            residentStatus: _clientts.ResidentStatus.FAMILY_MEMBERS,
            registrationStatus: _clientts.RegistrationStatus.AWAITING_FAMILY_APPROVAL,
    ...
    await prisma.familyApprovals.create({
        data: {
            ...
            status: _clientts.ApprovalStatus.PENDING,
        ...
        data: [
            {
                ...
                documentType: _clientts.DocumentType.ID_CARD,
            ...
            {
                residentId: headResident1.id,
                documentType: _clientts.DocumentType.FAMILY_CARD,
            ...
            {
                residentId: headResident2.id,
                documentType: _clientts.DocumentType.KPR_PROOF,
    ...
    const bill1 = await prisma.bills.create({
        data: {
            amount: 350000,
            type: _clientts.PaymentType.IURAN_BULANAN,
    ...
    const bill3 = await prisma.bills.create({
        data: {
            amount: 4200000,
            type: _clientts.PaymentType.CICILAN_KPR,
        ...
        data: [
            {
                ...
                description: 'Pipa utama di bawah sink dapur bocor deras sejak pagi ini.',
                category: _clientts.MaintenanceCategory.HIGH,
                status: _clientts.ComplaintStatus.IN_PROGRESS,
                residentId: headResident1.id,
            ...
            },
            {
                ...
                description: 'Lampu penerangan jalan di depan rumah A-102 mati total saat malam.',
                category: _clientts.MaintenanceCategory.MEDIUM,
                status: _clientts.ComplaintStatus.VERIFIED,
                residentId: headResident2.id,
                employeeId: techEmployee.id,
                unitId: units[1].id,
            ...
            },
            {
                ...
                category: _clientts.MaintenanceCategory.LOW,
                status: _clientts.ComplaintStatus.COMPLETED,
                residentId: headResident3.id,
                employeeId: techEmployee.id,
                unitId: units[9].id,
            ...
            },
            {
                ...
                description: 'Tumpukan sampah di tempat penampungan sementara belum diangkut 3 hari.',
                category: _clientts.MaintenanceCategory.URGENT,
                status: _clientts.ComplaintStatus.NEW,
                residentId: headResident1.id,
                unitId: units[0].id,
        ...
        data: [
            {
                ...
                content: 'Diimbau kepada seluruh warga untuk mengikuti kerja bakti massal pada hari Minggu, 2 Agustus 2026 pukul 07:00 WIB di Lapangan Utama.',
                employeeId: managerEmployee.id,
                publishDate: new Date('2026-07-25')
            },
            {
                title: 'Pemeliharaan Jaringan Listrik PLN',
                content: 'Akan dilakukan pemadaman listrik sementara untuk perbaikan pemeliharaan jaringan pada hari Kamis dari pukul 09:00 - 12:00 WIB.',
                employeeId: techEmployee.id,
            ...
            },
            {
                ...
                content: 'Setiap tamu wajib menyerahkan kartu identitas (KTP/SIM) di pos sekuriti gerbang utama demi keamanan bersama.',
    ...
    const tag1 = await prisma.postTags.create({
        data: {
            tagName: 'Fasilitas'
        }
    });
    const tag2 = await prisma.postTags.create({
        data: {
            tagName: 'Kegiatan'
        }
    });
    const tag3 = await prisma.postTags.create({
        data: {
            tagName: 'Keamanan'
        }
    });
    const post1 = await prisma.forumPosts.create({
        data: {
            ...
            content: 'Halo tetangga sekalian, bagaimana jika kita mengusulkan penambahan unit CCTV di area bermain anak-anak demi keamanan buah hati kita?',
            authorRole: _clientts.UserRole.RESIDENT,
            userId: headUser1.id,
            tags: {
                connect: [
                    {
    ...
    await prisma.forumComments.createMany({
        data: [
            ...
            {
                content: 'Saya dukung usulannya, nanti bisa kita bahas di rapat warga bulanan.',
                userId: managerUser.id,
                postId: post1.id
            }
        ]
    ...
    const post2 = await prisma.forumPosts.create({
        data: {
            ...
            content: 'Mari hidup sehat! Siapa yang berminat gabung senam dan jalan sehat tiap Sabtu jam 06:00 WIB?',
            authorRole: _clientts.UserRole.RESIDENT,
            userId: headUser3.id,
            tags: {
                connect: [
        ...
        data: [
            {
                ...
                role: _clientts.ContactRole.EMPLOYEE,
            ...
            },
            {
                ...
                role: _clientts.ContactRole.EMERGENCY_SERVICES,
                phoneNumber: '110',
        ...
        data: [
            {
                ...
                description: 'Patroli keliling malam pukul 02:00 WIB. Kondisi aman, pagar portir terkunci rapat.',
                location: 'Blok A dan Blok B',
                incidentDate: new Date('2026-07-28T02:00:00'),
                status: _clientts.MaintenanceStatus.COMPLETED,
                isPublished: true,
                employeeId: secEmployee.id
            },
            {
                title: 'Laporan Penemuan Kunci Rumah Tercecer',
                description: 'Ditemukan seikat kunci rumah di dekat area pos sekuriti utama. Pemilik dapat mengambilnya di pos.',
                location: 'Pos Utama',
                incidentDate: new Date('2026-07-29T16:30:00'),
                status: _clientts.MaintenanceStatus.NEW,
                isPublished: true,
                employeeId: secEmployee.id
            }
        ]
    });
    console.log('✅ Database Seeding Completed Successfully! (Total 70+ records created across all models)');
}
main().catch((e)=>{
